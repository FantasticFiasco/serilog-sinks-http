...
The project has defined a [code of conduct](https://github.com/FantasticFiasco/.github/blob/main/CODE_OF_CONDUCT.md), providing a welcoming and friendly environment. Please adhere to it in all interactions.
...
```sh
git clone https://github.com/<your username>/serilog-sinks-http.git
```

Navigate into the cloned directory and create a new branch:

```sh
cd serilog-sinks-http
...
[issues]: https://github.com/FantasticFiasco/serilog-sinks-http/issues
[issues_new]: https://github.com/FantasticFiasco/serilog-sinks-http/issues/new
[issues_bugs]: https://github.com/FantasticFiasco/serilog-sinks-http/issues?q=label%3Abug
[discussions]: https://github.com/FantasticFiasco/serilog-sinks-http/discussions
[discussions_new]: https://github.com/FantasticFiasco/serilog-sinks-http/discussions/new
